...
public class DataTypeMvcController extends
		AbstractMasterDetailMvcController<ProgLang, DataType, ProgLangServiceImpl, DataTypeServiceImpl, String> {
	 ...
	 * Name)
	 */
	public static final String COC_NAME = "dataTypes";
	...
	public DataTypeMvcController(ProgLangServiceImpl masterService, DataTypeServiceImpl service) {
		super(masterService, ProgLangMvcController.COC_NAME, service, BASE_URL, VN_PATH, CO_NAME, COC_NAME);
